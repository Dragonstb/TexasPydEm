...
class TexasPydEmGame_UT(UT.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # 2 to 5 of clubs and 7 of diamonds
        self.game.comCards = [0, 1, 2, 3, 5+13]
        ...
        # 4 of clubs and 9 of hearts: straight flush
        self.flush.pockets = [4, 7+26]
    ...
    def test_splitPotWithRemainder1(self):
        ...
        self.assertEqual(winners[self.twoPair],
                         stakes+1, 'incorrect higher win')
    ...
    def test_splitPotWithRemainder2(self):
        ...
        # player twoPair sits left to the dealer
        self.assertEqual(winners[self.twoPair], stakes+1,
                         'incorrect higher win: twoPair')
        # flush sits left to twoPair
        self.assertEqual(winners[self.flush], stakes+1,
                         'incorrect higher win: flush')
    ...
    def test_sidePotWithDifferentWinnersNoFolders(self):
        ...
        self.assertEqual(wins[self.flush], 300,
                         'player flush got incorrect value')
        self.assertEqual(wins[self.twoPair], 200,
                         'player twoPair got incorrect value')
    ...
    def test_sidePotWithDifferentWinnersAndFolders(self):
        ...
        self.assertTrue(self.flush in wins, 'player flush not detected')
        self.assertTrue(self.twoPair in wins, 'player twoPait not deteced')
        self.assertEqual(wins[self.flush], 400,
                         'player flush got incorrect value')
        self.assertEqual(wins[self.twoPair], 250,
                         'player twoPair got incorrect value')
